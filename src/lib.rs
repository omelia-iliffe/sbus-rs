...
pub(crate) const fn channels_parsing(buffer: &[u8; 25]) -> [u16; 16] {
    [
        ...
        (((buffer[3] as u16) >> 6) | ((buffer[4] as u16) << 2) | ((buffer[5] as u16) << 10)) & 0x07FF,
        (((buffer[5] as u16) >> 1) | ((buffer[6] as u16) << 7)) & 0x07FF,
        (((buffer[6] as u16) >> 4) | ((buffer[7] as u16) << 4)) & 0x07FF,
        (((buffer[7] as u16) >> 7) | ((buffer[8] as u16) << 1) | ((buffer[9] as u16) << 9)) & 0x07FF,
        ...
        (((buffer[14] as u16) >> 6) | ((buffer[15] as u16) << 2) | ((buffer[16] as u16) << 10)) & 0x07FF,
        (((buffer[16] as u16) >> 1) | ((buffer[17] as u16) << 7)) & 0x07FF,
        (((buffer[17] as u16) >> 4) | ((buffer[18] as u16) << 4)) & 0x07FF,
        (((buffer[18] as u16) >> 7) | ((buffer[19] as u16) << 1) | ((buffer[20] as u16) << 9)) & 0x07FF,
